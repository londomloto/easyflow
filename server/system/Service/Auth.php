...
class Auth extends \Sys\Core\Component {
    ...
    public function save($user) {
        ...
        if ($user->avatar) {
            $data->avatar_url = $this->getService('url')->getBaseUrl().'public/upload/avatar/'.$user->avatar;
        } else {
            $data->avatar_url = $this->getService('url')->getBaseUrl().'public/upload/avatar/avatar.png';
        }
